...
export async function fetchUsers({
    ...
    userId:string,
    searchString?:string,  // optional parameter
    pageNumber?: number,   // optional parameter
    pageSize?: number,     // optional parameter
    sortBy?: SortOrder     // optional parameter
}){
    ...
    try{
        ...
        const query: FilterQuery<typeof User> = {
            id: { $ne: userId }  // $ne means NOT EQUAL
        }
        ...
        const sortOptions = {cratedAt: sortBy}
